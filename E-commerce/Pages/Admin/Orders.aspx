            ...
            <div class="search-filter-container">
                <div class="filter-row">
                    <div class="filter-group" style="flex: 2;">
                        ...
                        <asp:TextBox ID="txtSearch" runat="server" CssClass="search-input" placeholder="Nom client, numéro de commande..." />
                    </div>
                    <div class="filter-group">
                        ...
                        <asp:DropDownList ID="ddlStatusFilter" runat="server" CssClass="search-input">
                            ...
                            <asp:ListItem Value="Processing" Text="En préparation"></asp:ListItem>
                            <asp:ListItem Value="Shipped" Text="Expédié"></asp:ListItem>
                            <asp:ListItem Value="Delivered" Text="Livré"></asp:ListItem>
                            <asp:ListItem Value="Cancelled" Text="Annulé"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="filter-row">
