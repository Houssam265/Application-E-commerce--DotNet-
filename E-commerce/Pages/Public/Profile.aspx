    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        <div class="container">
            ...
            <div id="tab-addresses"
                class='tab-content <%= GetActiveTabClass("addresses") == "active" ? "active" : "" %>'>
                <div class="card">
                    <div
                            ...
                            <div
                                ...
                                <%# GetDefaultBadge(Eval("IsDefault")) %>
                                    ...
                                    <div style="display: flex; gap: 0.5rem;">
                                        <a href='Addresses.aspx?id=<%# Eval("Id") %>' class="btn btn-outline"
                                            style="padding: 6px 12px; font-size: 0.9rem;">
                                            <i class="fas fa-edit"></i> Modifier
                                        </a>
                                        <asp:LinkButton ID="btnDelete" runat="server" CommandName="Delete"
                                            CommandArgument='<%# Eval("Id") %>' CssClass="btn"
                ...
                <asp:Label ID="lblNoAddresses" runat="server" Text="Aucune adresse enregistrée." Visible="false"
                    style="text-align: center; padding: 3rem; color: var(--text-light); display: block;"></asp:Label>
            </div>
        </div>
        </div>
        </div>
